...
const config: Configuration = {
  ...
  entry: {
    // "background.index": res("background", "prod.ts"),
    ...
    //   //dependOn: ["react", "react-dom", "styled-components"],
    // },
  ...
  //         chunks: (chunk) => {
  //           return chunk.name === "background/index";
  //         },
  //       },
  //       contentVendor: {
  //         test: /[\\/]node_modules[\\/]/,
  //         name: "content-vendor",
  //         chunks: (chunk) => {
  //           return chunk.name === "contentScripts/index.global";
  //         },
  //       },
  //       optionsVendor: {
  //         test: /[\\/]node_modules[\\/]/,
